...
import {
  ISummonerSpellResponse,
  SummonerSpell,
} from "../utils/@types/summonerSpell";

export const SummonerSpellContext = React.createContext<
  SummonerSpell[] | undefined
>([]);

export default function SummonerSpellProvider({
  children,
}: {
  children: ReactNode;
}) {
